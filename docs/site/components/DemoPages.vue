<template>
  <section class="x-doc-demo-pages">
    <h1>{{ $t('title') }}</h1>
    <div class="card">
      <p>{{ $t('description') }}</p>
      <div class="x-doc-demo-pages__gallery">
        <div
          :class="['x-doc-demo-pages__item', { 'x-doc-demo-pages__item--active': index === currentDemo }]"
