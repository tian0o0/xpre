...
export interface XpreComponentOptions extends ComponentOptions<Vue> {
  functional?: boolean;
...
function transformFunctionComponent(pure: FunctionComponent): XpreComponentOptions {
  return {
    functional: true,
    props: pure.props,
    model: pure.model,
...
export function createComponent(name: string) {
  return function<Props = DefaultProps, Events = {}, Slots = {}> (
    sfc: XpreComponentOptions | FunctionComponent
